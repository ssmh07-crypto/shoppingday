...
export const supplierProducts = pgTable(
  'supplier_products',
  {
    ...
    supplierCreatedAt: timestamp('supplier_created_at', { withTimezone: false }),
    supplierUpdatedAt: timestamp('supplier_updated_at', { withTimezone: false }),
...
export const productSupplierLinks = pgTable(
  ...
  (table) => [
    ...
    uniqueIndex('product_supplier_links_supplier_product_uidx').on(table.supplierProductId),
  ],
)
